...
static readonly SECUENCIA_LETRAS_DNI:string = "TRWAGMYFPDXBNJZSQVHLCKE";
  ...
  calcularLetra() : void
  {
    ...
    this.mostrarDniExtranjero();
  }

  mostrarDniExtranjero():void {
    
    this.listaDnisExtranjeros = this.listaDnis.filter(dni => dni.prefijo != '')
    console.log(this.listaDnisExtranjeros);
  }


  //TODO: Añadir un boton para ordenar por letra
  //TODO: HAcer un componente con el ejercicio del IMC peso, altura

  ordenarPorNumero():void {
    this.listaDnisExtranjeros.sort((a, b) => a.numero - b.numero);
  }
}